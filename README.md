LaTeX-шаблон для русской кандидатской/докторской диссертации и её автореферата.

## Модифицирован относительно оригинального шаблона:
...
3) Изменена обработка литературы для удобства интеграции с Zotero
4) Некоторые изменения субъективного характера и поддержка дополнительные пакетов (threeparttable, tabularx и др.)
